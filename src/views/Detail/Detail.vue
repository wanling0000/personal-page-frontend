...
import {chatRoom, myIndex, examples, ta, pm} from "./content/content.ts";
...
switch (id) {
	...
	case "ta": {
		document.title = "TA - Details";
		title.value = "Teaching Assistant for Software Engineering II module";
		text.value = ta;
		break;
	}
	case "pm": {
		document.title = "AI Product Manager (Intern) - Details";
		title.value = "AI Product Manager (Intern)";
		text.value = pm;
		break;
	}
}
